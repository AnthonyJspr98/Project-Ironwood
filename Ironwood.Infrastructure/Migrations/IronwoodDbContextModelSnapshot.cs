...
namespace Ironwood.Infrastructure.Migrations
{
    ...
    partial class IronwoodDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ironwood.Domain.Entities.MatchCategory", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Ironwood.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Admin",
                            LastName = "App",
                            UID = new Guid("56665a08-370d-41d0-b901-eee8a10b9f5c")
                        });
                });
            ...
            modelBuilder.Entity("Ironwood.Domain.Entities.Match", b =>
                {
                    b.HasOne("Ironwood.Domain.Entities.MatchCategory", "MatchCategory")
                        .WithMany("Matches")
